...
<tr>
   <td>SUBJECT:</td>
   <td><input type="text" class="form-control" placeholder="ENTER SUBJECT NAME"style="width:350px;height:40px;" name="t1">
</td>
</tr>
<tr>
...
<tr>
   <td>L-DATE:</td>
   <td><input type="date" class="form-control"style="width:350px;height:40px;" name="t2">
</td>
</tr>
<tr>
   <td>TITLE</td>
   <td><input type="text" class="form-control" placeholder="PLEASE ENTER TITLE NAME"style="width:350px;height:40px;" name="t3">
</td>
</tr>
<tr>
   <td>FILE</td>
   <td><input type="file" class="form-control1" placeholder=""style="width:350px;height:40px;" name="t4" class="fil">
</td>
</tr>

</table>
<input type="submit" value="ADD" class="btn btn-info" style="margin-left:38%;">
</div>
...
<?php
  ...
  if(isset($_POST['t1']))
  {
      ...
      $c=$_POST['t3'];
      $d=$_FILES['t4']['name'];
      $e=$_FILES['t4']['tmp_name'];
      $cd=date('d/m/y h:i:sa');
      
      
     

      if(move_uploaded_file($e,$d))
      {
      $con=mysqli_connect('localhost','root','','growup');
     $sel="insert into note values('$a','$b','$c','$d','$cd')";
