        ...
        <div class="container1">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="student page.php" class="c">Back</a></li>
...
<tr>
   ...
   ";
while ($fe = mysqli_fetch_array($rs)) {
  ...
  <tbody>
    ...
    <td>$fe[sub]</td>
      <td>$fe[ldate]</td>
      <td>$fe[title]</td>
      <td><a href=$fe[file]>downlod</a></td>
      <td>$fe[submit]</td>
