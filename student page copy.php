    ...
    <link
     ...
     <style>
        ...
        h5{
          ...
          color:white; font-size:25px; margin-top:0;
...
<div class="jumbotron text-center">
        ...
        <p style="font-weight: bolder; color:white">"Empowering Dreams Through Knowledge: Unleashing Your Potential at Our Coaching Institute. 
           Join us to embark on a transformative learning journey guided by expert mentors and innovative teaching techniques</p>
    </div>
<br>
<br>
                ...
                <p> A coaching institute is an educational center that offers specialized instruction and guidance to
                     ...
                     courses, study materials, and expert tutors to help students excel in various subjects, entrance exams,
                      ...
                      institutes aim to foster a deeper understanding of subjects and boost confidence. They often play a crucial
                       role in preparing students for competitive exams and academic challenges, enabling them to achieve their educational and career goals effectively. </p><br>
                
                       <div class="container">
  
  <!-- Trigger the modal with a button -->
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="margin-left:">notification</button>
...
while($row=mysqli_fetch_array($rs))
{
   ...
   <div id="myCarousel" class="carousel slide" data-ride="carousel" style="width:400px;">
     ...
     <div class="carousel-inner">
       ...
       <div class="item">
         <img src= "https://th.bing.com/th/id/OIP.8iLW1rKoD5D9Z8OR2uhVvgHaE8?pid=ImgDet&w=1200&h=800&rs=1" alt="Chicago">
       </div>
...
<div class="col-sm-1"></div>
<div class="col-sm-4">
  <img src="https://99designs-blog.imgix.net/blog/wp-content/uploads/2019/10/attachment_74243024-e1570748962600.jpeg?auto=format&q=60&fit=max&w=930" style="height:550px;width:450px;">
</div>

<div class="col-sm-6"><h1 style="font-weight:bolder;">Why is education important?</h1>
<p> 
Deep down, every good teacher knows the impact and importance of education. It isn’t just about learning reading,
 writing and arithmetic at school. Instead, formal education is about gaining the knowledge and the skills needed to 
...
<p>I remember my first teacher. I remember the teachers I had throughout primary school, and some of the faces of the teachers I had in Nursery school.
...
A run-in with a friend who became a teacher recently had me reflecting on this truth, and so I wanted to see the truth of education through the eyes of leaders in history.</p>
...
<br><a href="view attendance.php"> <button class="btn btn-default btn-lg">view attandance</button></a>
 ...
 <h1 style="color:white; text-align:center;">We're Good With Numbers</h1>
  ...
  <h5 style="text-align:center; ">Year Of  Experience &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Qualified Experts</h5>
...
<p>"Tests: where knowledge transforms into action, and understanding meets challenge. 
  ...
  Embrace the journey, for within these moments of inquiry, you define your comprehension and unveil your potential."
<br>
...
<h1 style="font-family: 'Cinzel', serif;font-size:40px;">How social media affects the education:</h1>
   <p>Positive: Social media enhances education by providing easy access to information, global 
    collaboration, interactive learning, and resource sharing, fostering a dynamic and enriched educational experience.
...
<div class="row">
  ...
  <div class="col-sm-1"></div>
  <div class="col-sm-5">
    <img src="https://www.sra-architecture.co.uk/wp-content/uploads/2021/06/SRA_WestBridgfordSchool_008_A_compressed-scaled-e1624617874530-1024x678.jpg" style="height:400px;">
    </div>
    <div class="col-sm-6">
    <h4 style="font-size:45px; margin-top:50px;">Career<h4><br><br>
      <p>"A career is a lifelong journey of professional growth and fulfillment.
         ...
         Navigating a career involves continuous learning, adapting to change,
          and aligning passions with opportunities to create a meaningful and successful vocational trajectory."</p>
